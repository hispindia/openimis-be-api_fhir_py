...
from api_fhir.models.claim import ClaimService
from django.db import connection

class ClaimServiceConverter(BaseFHIRConverter, PersonConverterMixin, ReferenceConverterMixin):

    @classmethod
    def to_fhir_obj(cls, imis_insuree):
        fhir_patient = ClaimService()
    ...
    def build_fhir_extensions(cls, imis_insuree, fhir_patient):
        ...
        def buildall(component,urlvalue):
             def build_extension_component(imis_insuree, fhir_patient):
                  variable = component
                  extension = Extension()
                  extension.url = "http://hispindia.org/fhir/StructureDefinition/ClaimService/"+urlvalue
        ...
        buildall(fhir_patient.limitation_value,"limitation_value")
        ...
        buildall(fhir_patient.service_id,"service_id")
